           ...
           {{-- @if(Auth::user()->hasRole('user'))
            ...
            @endif
              ...
              <div class="flex">
                ...
                {{-- fore=user --}}
                @if (Auth::user()->hasRole('user') && $item->status != 'sold')
                ...
                {{-- for admin --}}
                {{-- edit and delete --}}
                @if(Auth::user()->hasRole('admin') && $item->status != 'sold')
              ...
              @if (Auth::user()->hasRole('user') && $item->status == 'sold')
            <div>
              @if ($order->secret_key != null && $order->buyerid === Auth::id())
              
              <h4 style="color:goldenrod" class="leading-relaxed">Secret key: {{$order->secret_key}}</h4>
              @else
              <h4 style="color:goldenrod" class="leading-relaxed"></h4>
              @endif
            </div>
         @endif
            </div>
