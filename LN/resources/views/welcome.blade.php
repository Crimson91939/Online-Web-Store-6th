            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Light Novel ONLINE STORE</h1>
	                        <p class="hero-paragraph">Buy products online during this pandemic and get the products deliverred to you on MONDAY</p>
                ...
                <div class="container-sm">
                    <div class="pricing-inner section-inner">
                        <div class="pricing-header text-center">
                            <h2 class="section-title mt-0">Thousands of books to explore from</h2>
                            <p class="section-paragraph mb-0">
                                we upload new book ever time truck kun sends some to issekai.So sit back and enjoy
                            </p>
                        </div>
